...
class BaseDocumentParser(ABC):
    ...
    def _print_processing_header(self, document_type: str, source_file: str) -> None:
        ...
        print("\n" + "=" * 80)
        print(f"🔄 {document_type.upper()} PROCESSING PIPELINE")
        print("=" * 80)
        print(f"\n📄 STEP 1: Reading {document_type}")
        print("-" * 40)
    ...
    def _print_completion_message(
        ...
        print("\n" + "=" * 80)
        print(f"📊 {document_type.upper()} PROCESSING SUMMARY")
        print("=" * 80)
        print(f"• Source File: {Path(source_file).name}")
        print(f"• Processing Steps Completed: {steps}")
