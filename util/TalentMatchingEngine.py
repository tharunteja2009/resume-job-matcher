...
from teams.talent_matching_team import get_talent_matching_workflow
...
class TalentMatchingEngine:
    ...
    async def perform_comprehensive_analysis(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            # Prepare the comprehensive analysis request
            analysis_request = f"""
            Please perform a comprehensive matching analysis of the entire talent pool and job market.
            
            Use the comprehensive_analysis_tool to:
            1. Analyze overall talent pool statistics
            2. Identify top matching patterns
            3. Provide strategic hiring insights
            4. Suggest talent acquisition strategies
            5. Highlight skills gaps and market trends
            
            Provide detailed insights including:
            - Total candidates and jobs in system
